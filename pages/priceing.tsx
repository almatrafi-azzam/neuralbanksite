...
const hobbyFeatures = ['الشيء الأول', 'Sapiente libero doloribus', 'Vel ipsa esse repudiandae']
...
export default function Example() {
  return (
    <div className="max-w-7xl mx-auto sm:px-6 lg:px-16 lg:py-16 font-Tajawal bg-gray-50">
    <div className="bg-gray-900">
      <div className="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
        <div className="text-center">
          <h2 className="text-lg leading-6 text-gray-300 uppercase tracking-wider">الأسعار</h2>
          <p className="mt-2 text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl">
            السعر المناسب لك
          </p>
          <p className="mt-3 max-w-4xl mx-auto text-xl text-gray-300 sm:mt-5 sm:text-2xl">
            أسعارنا عادلة. أدفع على حسب إستخدامك لبياناتنا
          </p>
        </div>
      </div>

      <div className="mt-16 bg-gray-50 pb-12 lg:mt-20 lg:pb-20">
                    ...
                    <div className="bg-white px-6 py-10">
                      <div>
                        <h3 className="text-center text-2xl font-medium text-gray-900" id="tier-hobby">
                          البيانات المعاد معالجتها
                        </h3>
                        <div className="mt-4 flex items-center justify-center">
                          <span className="text-xl font-medium text-gray-500">للشهر/</span>
                          <span className="px-3 flex items-start text-6xl tracking-tight text-gray-900">
                            <span className="mt-2 mr-2 text-4xl font-medium">ر.س.</span>
                ...
                <div className="relative z-10 rounded-lg shadow-xl">
                  ...
                  <div className="bg-white rounded-t-lg px-6 pt-12 pb-10">
                    <div>
                      ...
                      <div className="mt-4 flex items-center justify-center">
                        <span className="text-2xl font-medium text-gray-500">للشهر /</span>
                        <span className="px-3 flex items-start text-6xl tracking-tight text-gray-900 sm:text-6xl">
                          <span className="mt-2 mr-2 text-4xl font-medium">ر.س.</span>
                          <span className="font-extrabold">2499</span>
                        </span>

                      </div>
                    </div>
                  </div>
                  <div className="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 sm:px-10 sm:py-10 text-right">
                    <ul role="list" className="space-y-4">
